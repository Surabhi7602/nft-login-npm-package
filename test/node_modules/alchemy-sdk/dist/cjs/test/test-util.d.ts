...
import { BaseNft, BaseNftContract, Nft, NftContract, NftTokenType, OwnedBaseNft, OwnedNft, TokenUri } from '../src';
...
export declare function verifyNftContractMetadata(actualNftContract: NftContract, expectedNftContract: NftContract, address: string, name: string, symbol: string, totalSupply: string, tokenType?: NftTokenType): void;
